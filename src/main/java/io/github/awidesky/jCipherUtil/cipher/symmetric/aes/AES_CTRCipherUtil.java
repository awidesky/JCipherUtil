...
public class AES_CTRCipherUtil extends SymmetricNonceCipherUtil {
	...
	private AES_CTRCipherUtil(CipherProperty cipherMetadata, KeyMetadata keyMetadata, KeySize keySize, SymmetricKeyMaterial key, int bufferSize) {
	 ...
	 * */
	private AES_CTRCipherUtil(CipherProperty cipherMetadata, KeyMetadata keyMetadata, KeySize keySize, SymmetricKeyMaterial key, int bufferSize, int counterLength) {
